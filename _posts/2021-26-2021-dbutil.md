...
DWORD64 Memory::GetEPROCESSPointer(_In_ DWORD64 ntoskrnlBase, _In_ std::string processName) {
	...
	UCHAR testName[15];
	this->VirtualRead(initialSystemProcess + EPROCESS_NAME, testName, sizeof(testName));
