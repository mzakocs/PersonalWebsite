...
| **Architecture Type**   |                                                                          Stack Machine, Randomized Instructions                                                                         |
| **Context Variables**   | Stored on stack and accessed through stack frame offset. <br>Includes a local variable space, a virtual stack, a virtual instruction pointer, and any parameters passed to the function |
...
|:------------------------------------------------------:|:------------------------------------------------------------------:|
| Free, Randomized Architecture, Incredibly Customizable | Relatively Simple VM, No Encryption, Only Works with C Source Code |
