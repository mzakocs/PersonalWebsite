  ...
  return (
    <footer>
      ...
      <div className="container">
        <div className="flex">
          <div>
            <a target="_blank" rel="noopener" href="https://github.com/mzakocs" title="GitHub">
            ...
            <a target="_blank" rel="noopener" href="https://www.linkedin.com/in/mitchzakocs/" title="LinkedIn">
              <svg className="social-svg" viewBox="0 0 64 64">
                <g>
                  <circle cx="32" cy="32" r="31"></circle>
                </g>
          ...
          <a>Mitchell Zakocs • {new Date().getFullYear()}</a>
        </div>
      </div>
    </footer>
  );
